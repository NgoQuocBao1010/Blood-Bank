...
const handleSubmitForm = async () => {
    ...
    if (!v$.value.$error) {
        ...
        const data = {
            ...
            dateSubmitted: new Date().getTime().toString(),
        };
                    ...
                    <div class="form-donation flex justify-content-center">
                                    ...
                                    <div class="p-fluid">
                                        ...
                                        <div class="field">
                                            ...
                                            <small
                                                class="p-error"
                                                v-if="
                                                    v$.idCardNumber.$error &&
                                                    submitted
                                                "
                                                >{{
                                                    v$.idCardNumber.$errors[0]
                                                        .$message
                                                }}</small
                                            >
                                        </div>
                                        <div class="field">
                                            ...
                                            >
                                                <div
                                                    class="field-radiobutton mr-3 text-800"
                                                >
                                                    <RadioButton
                                                        id="male"
                                                        name="gender"
                                        ...
                                        <div class="field">
                                            <label for="phone" class="text-800"
                                                >Phone*:</label
                                            >
                                            <InputText
                                                id="phone"
                                        ...
                                        <div class="field">
                                            <label for="email" class="text-800"
                                                >Email*:</label
                                            >
                                            <InputText
                                                id="email"
                                        ...
                                        <div class="field">
                                            <label class="mb-2 text-800"
                                                >Medical history</label
                                            >
                                            <div class="formgrid grid">
                                                <div
                                                    class="field-radiobutton col-6 text-800"
                                                >
                                                    <Checkbox
                                                        id="high_blood"
                                                        name="medicalHistory"
                        ...
                        >
                            ...
                            <p class="line-height-3 m-0 text-800">
                                <span
                                    >Start Date:
                                    {{ formatDate(eventData.startDate) }}</span
                                >
                                <br />
                                <span
                                    >Duration:
                                    {{ eventData.duration }} days</span
                                >
                            </p>
