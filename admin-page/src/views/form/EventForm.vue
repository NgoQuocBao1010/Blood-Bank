...
const fectchData = {
  ...
  duration: 300,
  detail:
    "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi esse porro odio ea doloribus quaerat iste quae reprehenderit asperiores animi.",
};
// *** End mock data ***
      ...
      <div class="card">
        ...
        <div class="p-fluid formgrid grid">
          ...
          <div class="field col-12 md:col-6">
            ...
            ></Dropdown>
            <span v-if="$v.location.city.$error" class="app-form-error">
              This field is required
            </span>
          </div>
          ...
          <div class="field col-12 md:col-6">
            ...
            />
            <span v-if="$v.location.address.$error" class="app-form-error">
              This field is required
            </span>
          </div>
