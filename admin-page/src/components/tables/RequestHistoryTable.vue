    ...
    try {
        ...
        if (e.response && e.response.status === 400) {
            toast.add({
                ...
                detail: "The storage does not have enough blood to approve this request. Please decrease the quantity!",
                life: 10000,
            });
...
<template>
    <div>
                ...
                <template #filter="{ filterModel, filterCallback }">
                    ...
                    >
                        <template #option="slotProps">
                            <span
                                :class="'blood-badge type-' + slotProps.option"
                            >
        ...
        <Dialog
            :header="
                isApprove ? 'Approving blood requests' : 'Reject blood requests'
            "
