...
const router = createRouter({
  ...
  routes: [
    ...
    // Hospital pages
    {
      ...
      name: "Hospital Page",
      component: () => import("./views/hospital-pages/HospitalRequest.vue"),
      meta: {
        layoutName: "LayoutDefault",
        isHospital: true,
      },
    },
    {
      ...
      component: () => import("./views/hospital-pages/HospitalProfile.vue"),
      meta: {
        layoutName: "LayoutDefault",
        isHospital: true,
      },
...
router.beforeEach(async (to, from, next) => {
  ...
  try {
    ...
    if (err.response) {
      ...
      if (err.response.status === 500) return next({ name: "Server Error" });
    }
